package org.personal.info_service.mapper;
...
@Component
public class ToiletInfoMapper {

    // ToiletInfoResponse를 ToiletInfo로 변환하는 메서드
    public ToiletInfo convertRequestCreateInfoToToiletInfo(RequestCreateInfo response) {
    ...
    public ToiletInfoResponse convertToiletInfoToResponse(ToiletInfo toiletInfo) {
