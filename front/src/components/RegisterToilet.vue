  ...
  <div>
    ...
    <form @submit.prevent="submitForm">
      ...
      <div>
        ...
        <input id="toiletRegistManagementAgency" v-model="form.toiletRegistManagementAgency" required />
      </div>
      <div>
        <label for="toiletRegistPhoneNumber">Phone Number:</label>
        <input id="toiletRegistPhoneNumber" v-model="form.toiletRegistPhoneNumber" required />
      </div>
      <div>
        <label for="toiletRegistOpeningHours">Opening Hours:</label>
        <input id="toiletRegistOpeningHours" v-model="form.toiletRegistOpeningHours" required />
      </div>
      <div>
      ...
      <div>
        ...
        <input id="toiletRegistInstallationYearMonth" v-model="form.toiletRegistInstallationYearMonth" required />
      </div>
      <div>
        <label for="toiletRegistOwnershipType">Ownership Type:</label>
        <input id="toiletRegistOwnershipType" v-model="form.toiletRegistOwnershipType" required />
      </div>
      <div>
        <label for="toiletRegistWasteDisposalMethod">Waste Disposal Method:</label>
        <input id="toiletRegistWasteDisposalMethod" v-model="form.toiletRegistWasteDisposalMethod" required />
      </div>
      <div>
      ...
      <div>
        ...
        <input type="number" id="toiletRegistMaleToiletsNumber" v-model="form.toiletRegistMaleToiletsNumber" required />
      </div>
      <div>
        <label for="toiletRegistMaleUrinalsNumber">Male Urinals Number:</label>
        <input type="number" id="toiletRegistMaleUrinalsNumber" v-model="form.toiletRegistMaleUrinalsNumber" required />
      </div>
      <div>
        <label for="toiletRegistMaleDisabledToiletsNumber">Male Disabled Toilets Number:</label>
        <input type="number" id="toiletRegistMaleDisabledToiletsNumber" v-model="form.toiletRegistMaleDisabledToiletsNumber" required />
      </div>
      <div>
        <label for="toiletRegistMaleDisabledUrinalsNumber">Male Disabled Urinals Number:</label>
        <input type="number" id="toiletRegistMaleDisabledUrinalsNumber" v-model="form.toiletRegistMaleDisabledUrinalsNumber" required />
      </div>
      <div>
        <label for="toiletRegistMaleChildToiletsNumber">Male Child Toilets Number:</label>
        <input type="number" id="toiletRegistMaleChildToiletsNumber" v-model="form.toiletRegistMaleChildToiletsNumber" required />
      </div>
      <div>
        <label for="toiletRegistMaleChildUrinalsNumber">Male Child Urinals Number:</label>
        <input type="number" id="toiletRegistMaleChildUrinalsNumber" v-model="form.toiletRegistMaleChildUrinalsNumber" required />
      </div>
      <div>
        <label for="toiletRegistFemaleToiletsNumber">Female Toilets Number:</label>
        <input type="number" id="toiletRegistFemaleToiletsNumber" v-model="form.toiletRegistFemaleToiletsNumber" required />
      </div>
      <div>
        <label for="toiletRegistFemaleDisabledToiletsNumber">Female Disabled Toilets Number:</label>
        <input type="number" id="toiletRegistFemaleDisabledToiletsNumber" v-model="form.toiletRegistFemaleDisabledToiletsNumber" required />
      </div>
      <div>
        <label for="toiletRegistFemaleChildToiletsNumber">Female Child Toilets Number:</label>
        <input type="number" id="toiletRegistFemaleChildToiletsNumber" v-model="form.toiletRegistFemaleChildToiletsNumber" required />
      </div>
      <div>
  ...
  data() {
    return {
      form: {
        ...
        toiletRegistMaleToiletsNumber: 0,
        toiletRegistMaleUrinalsNumber: 0,
        toiletRegistMaleDisabledToiletsNumber: 0,
        toiletRegistMaleDisabledUrinalsNumber: 0,
        toiletRegistMaleChildToiletsNumber: 0,
        toiletRegistMaleChildUrinalsNumber: 0,
        toiletRegistFemaleToiletsNumber: 0,
        toiletRegistFemaleDisabledToiletsNumber: 0,
        toiletRegistFemaleChildToiletsNumber: 0,
        userEmail: ''
      },
    };
  },
  methods: {
    async submitForm() {
      try {
        ...
        const response = await axios.post('http://localhost:8765/toiletregists', this.form);
