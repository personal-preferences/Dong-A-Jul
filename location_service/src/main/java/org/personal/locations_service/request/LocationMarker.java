...
public record LocationMarker(
        ...
        @Min(value = -90, message = "서남쪽 위도는 -90보다 크거나 같아야 합니다.")
        @Max(value = 90, message = "서남쪽 위도는 90보다 작거나 같아야 합니다.")
        Float southWestLatitude,

        @NotNull(message = "서남쪽 경도를 입력하세요.")
        @Min(value = -180, message = "서남쪽 경도는 -180보다 크거나 같아야 합니다.")
        @Max(value = 180, message = "서남쪽 경도는 180보다 작거나 같아야 합니다.")
